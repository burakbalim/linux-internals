...
`mmap_demo` pauses before unmapping, so you can inspect it from another shell with
`./build/procmon maps <pid>` and see the mapping in the process's address space.
