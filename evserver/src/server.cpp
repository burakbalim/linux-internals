...
const char* backend_name(Backend backend) {
    switch (backend) {
        case Backend::ThreadPerConnection: return "thread-per-connection";
        case Backend::EpollLevel:          return "epoll (level-triggered)";
        case Backend::EpollEdge:           return "epoll (edge-triggered)";
    }
    return "unknown";
}
