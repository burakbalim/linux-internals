...
namespace proc
{
    ...
    std::string state_name(char state)
    {
        ...
        {
        case 'R':
            return "Running (on CPU or runnable)";
        case 'S':
            return "Sleeping (interruptible)";
        case 'D':
            return "Disk sleep (uninterruptible, usually I/O)";
        case 'Z':
            return "Zombie (exited, not yet reaped)";
        case 'T':
            return "Stopped (SIGSTOP)";
        case 't':
            return "Tracing stop (debugger)";
        case 'X':
            return "Dead";
        case 'I':
            return "Idle (idle kernel thread)";
        default:
            return "Unknown";
        }
    }
